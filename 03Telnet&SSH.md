...
| --------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `(config)#hostname R1`                              | Router1 ตั้งชื่อเป็น R1, Router2 ตั้งชื่อเป็น R2<br><br>  <br><br>กรณีเป็น Switch เช่น Switch1 ตั้งชื่อเป็น S1 |
...
| `(config)#username admin privilege 15 secret cisco` | ตั้งค่า local username `admin` มี privilege login (15)<br><br>  <br><br>และ password secret `cisco`            |
